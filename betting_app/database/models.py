...
class Sentiment(Base):
    ...
    sentiment_score_1_10 = Column(Integer, nullable=True)  # 1-10 scale (10=positive)
    volume = Column(Integer, nullable=True)  # headline count
    confidence = Column(Float, nullable=True)  # volume-based confidence 0.0-1.0
    timestamp = Column(DateTime(timezone=True), server_default=func.now())
